    ...
    * item[+]
      ...
      * item[+]
        ...
        * item[+]
          ...
          * enableBehavior = #all
          * disabledDisplay = #hidden
          * answerOption[+].valueCoding = $SCT#94222008 "bot"
          * answerOption[+].valueCoding = $SCT#94225005 "hersenen"
          * answerOption[+].valueCoding = $SCT#94493005 "pleura"
          * answerOption[+].valueCoding = $SCT#94161006 "bijnier"
          * answerOption[+].valueCoding = $SCT#94381002 "lever"
          * answerOption[+].valueCoding = $SCT#94391008 "long"
          * answerOption[+].valueCoding = AutoGenerated#urn:uuid:daed7594-e079-4cbb-b181-fb45d19fe0c3 "extrathoracale lymfeklieren"
