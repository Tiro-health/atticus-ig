...
* bodySite = $SCT#52509004 "Structure of aortic valve ring"
* method = $SCT#113091000 "Magnetic resonance imaging"
* effectiveDateTime = "2026-05-02T10:30:00+02:00"
* component[0].code = $SCT#803681000000100 "Long axis"
* component[=].valueQuantity = 25.4 $UCUM#mm "mm"
* component[+].code = $SCT#80369100000010X "Short axis"
...
* bodySite = $SCT#41216001 "Prostatic structure"
* method = $SCT#373125008 "Transrectal ultrasonography"
